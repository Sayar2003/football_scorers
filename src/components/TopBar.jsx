    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          borderRadius: '10px', color: isDark ? 'rgba(255,255,255,0.7)' : 'rgba(0,0,0,0.7)',
          cursor: 'pointer', padding: '8px 12px', fontSize: '18px',
          transition: 'all 0.2s', flexShrink: 0,
          boxShadow: 'none'
        }}
        onMouseEnter={e => e.target.style.boxShadow = '0 0 12px rgba(59,130,246,0.3)'}
      ...
      <div style={{ position: 'relative', flexShrink: 0 }}>
        ...
        {showUserMenu && (
          <div style={{
            ...
            background: isDark ? 'rgba(15,17,23,0.95)' : 'rgba(240,245,255,0.95)',
            backdropFilter: 'blur(20px)',
            border: isDark ? '1px solid rgba(255,255,255,0.1)' : '1px solid rgba(0,0,0,0.1)',
            ...
            <div style={{
              ...
              <div style={{ fontSize: '12px', color: isDark ? 'rgba(255,255,255,0.4)' : 'rgba(0,0,0,0.4)', marginTop: '2px' }}>
                {user?.email}
              </div>
            </div>
