  ...
  backdropFilter: 'blur(10px)', outline: 'none'
      ...
      {cardType === 'player' && (
        <select
          ...
          style={{
            width: '100%', padding: '0.75rem', borderRadius: '8px',
            border: `1px solid ${glass.colors.border}`, backgroundColor: glass.card,
            ...
            <div ref={cardRef} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ textAlign: 'center', padding: '0 1rem' }}>
                  ...
                  <div style={{ color: glass.colors.muted, fontSize: '12px', marginTop: '4px' }}>Full Time</div>
                </div>
                <div style={{ textAlign: 'center', flex: 1 }}>
                  <div style={{
                    width: '56px', height: '56px', borderRadius: '50%',
            ...
            <div ref={cardRef} style={{
              ...
              <div style={{ display: 'flex', gap: '0.75rem' }}>
                {[
                  ...
                  { label: 'Matches', value: selectedPlayerData.playedMatches, color: glass.colors.blue },
                ].map(stat => (
          ...
          {(cardType === 'match' && selectedMatchData) && (
            <div>
              ...
              <div style={{
                ...
                border: `1px solid ${glass.colors.border}`, backgroundColor: glass.card,
                color: glass.colors.muted, fontSize: '12px', lineHeight: '1.6',
